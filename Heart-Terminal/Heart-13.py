...
def main():
    ...
    try:
        while True:
            ...
            angle_x = 0.2 * math.sin(current_time * 0.5)  # Изменение угла X для пульсации
            angle_z = 0.1 * math.cos(current_time * 0.3)  # Изменение угла Z для вращения
...
if __name__ == "__main__":
    try:
        ...
        print('\033[2 J\033[H')  # Очистка экрана
